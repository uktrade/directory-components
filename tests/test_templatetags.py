...
def test_ga360_tracker_tags_links_with_ga_class():
    template = Template(
    ...
    expected_html = \
        '<div>' \
        ' <a data-ga-class="link" href="https://example.com">Click Me</a>' \
        '</div>'
    assert rendered_html == expected_html


def test_ga360_tracker_can_use_variables_from_template():
    template = Template(
        '{% load ga360_tracker from directory_components %}'
        '{% with "link" as my_link %}'
        '{% ga360_tracker my_link %}'
        '<div>'
        '   <a href="https://example.com">Click Me</a>'
        '</div>'
        '{% endga360_tracker %}'
...
def test_ga360_tracker_tags_links_other_elements_if_specified():
    template = Template(
        '{% load ga360_tracker from directory_components %}'
        '{% ga360_tracker "introduction-video" target="video" %}'
        '<div>'
        '   <a href="https://example.com">Click Me</a>'
    ...
    expected_html = \
        '<div>' \
        ' <a href="https://example.com">Click Me</a>' \
        ' <video data-ga-class="introduction-video" src="/my-video"></video>' \
        '</div>'
    assert rendered_html == expected_html


def test_ga360_tracker_tags_all_matching_elements():
    template = Template(
        '{% load ga360_tracker from directory_components %}'
        '{% ga360_tracker "link" %}'
        '<div>'
    ...
    expected_html = \
        '<div>' \
        ' <a data-ga-class="link" href="https://example.com/1">Link 1</a>' \
        ' <a data-ga-class="link" href="https://example.com/2">Link 2</a>' \
        '</div>'
    assert rendered_html == expected_html


def test_ga360_tracker_can_optionally_tag_ga_value():
    template = Template(
        '{% load ga360_tracker from directory_components %}'
        '{% ga360_tracker "link" ga_value="Link" %}'
        '<div>'
        '   <a href="example.com">'
        '       <div>'
        '           <span>My Link</span>'
    ...
    expected_html = \
        '<div>' \
        ' <a data-ga-class="link" data-ga-value="Link" href="example.com">' \
        ' <div>' \
        ' <span>My Link</span>' \
        ' </div>' \
        ' </a>' \
